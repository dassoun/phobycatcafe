...
ALTER TABLE `player` ADD `score_cat_1` tinyint(2) DEFAULT NULL;
ALTER TABLE `player` ADD `score_cat_2` tinyint(2) DEFAULT NULL;
ALTER TABLE `player` ADD `score_cat_3` tinyint(2) DEFAULT NULL;
ALTER TABLE `player` ADD `score_cat_4` tinyint(2) DEFAULT NULL;
ALTER TABLE `player` ADD `score_cat_5` tinyint(2) DEFAULT NULL;
ALTER TABLE `player` ADD `score_cat_6` tinyint(2) DEFAULT NULL;
ALTER TABLE `player` ADD `score_col_1` tinyint(2) DEFAULT NULL;
ALTER TABLE `player` ADD `score_col_2` tinyint(2) DEFAULT NULL;
ALTER TABLE `player` ADD `score_col_3` tinyint(2) DEFAULT NULL;
ALTER TABLE `player` ADD `score_col_4` tinyint(2) DEFAULT NULL;
ALTER TABLE `player` ADD `score_col_5` tinyint(2) DEFAULT NULL;
